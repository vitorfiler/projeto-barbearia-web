export enum MessagesSnackBar {
  ...
  VISUALIZACAO_PRODUTO_ALTERADA_SUCESSO = "Visualização de produto alterada com sucesso",
  VISUALIZACAO_PRODUTO_ALTERADA_ERRO = "Falha ao alterar a visualização deste produto",
  ...
  CADASTRO_SERVICO_SUCESSO = "Serviço cadastrado com sucesso",
  CADASTRO_SERVICO_ERRO = "Falha ao cadastrar serviço",
  ALTERACAO_SERVICO_SUCESSO = "Serviço alterado com sucesso",
  ...
  CADASTRO_PRODUTO_SUCESSO = "Produto cadastrado com sucesso",
